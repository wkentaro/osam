...
- Cancelling a model download interrupts stalled response reads promptly instead of waiting for the network timeout. ([#101](https://github.com/wkentaro/osam/pull/101))
